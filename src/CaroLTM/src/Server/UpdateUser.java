...
public class UpdateUser extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        // Hien thi thong tin khi mo cua so UpdateUser
        tx_username.setText(us.getUsername().trim());
        tx_password.setText(us.getPassword().trim());
        tx_win.setText(String.valueOf(us.getWin()).trim());
        tx_lose.setText(String.valueOf(us.getLose()).trim());
        tx_score.setText(String.valueOf(us.getScore()).trim());
    ...
    private void bt_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_updateActionPerformed
        ...
        if (tx_username.getText().equalsIgnoreCase("")
            ...
            JOptionPane.showMessageDialog(null, "Hãy điền đầy đủ", "Lỗi", 1);
            return;
        }
//        Them vao user
...
//        Cap nhat va thong bao
        try {
            df.updateUser(us);
            JOptionPane.showMessageDialog(null, "Cập nhật thành công!", "Thành công", 1);
